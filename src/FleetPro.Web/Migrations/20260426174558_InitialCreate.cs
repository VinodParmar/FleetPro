...
{
    /// <summary>
    /// Baseline migration — Database schema already exists (created from SQL script).
    /// Creates MenuItems table and seeds menu data.
    /// </summary>
    public partial class InitialCreate : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP TABLE IF EXISTS [MenuItems];");
        }
    }
}
